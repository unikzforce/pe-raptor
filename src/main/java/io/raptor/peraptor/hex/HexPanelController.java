...
//    private TableColumn<HexTableRowModel, String> colF;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        button1.setOnMouseClicked(event -> button2.setTranslateX(button2.getTranslateX() + 50));
...
//        try (FileInputStream is = new FileInputStream("C:/Users/saranium/workspace/java/pe-raptor/usf.exe")) {
//            int b;
//            int lineCount=0;
//            boolean eof = false;
//            long adr = 0L;
